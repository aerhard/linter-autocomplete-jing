...
var matchRule = function matchRule(data) {
  return (0, _find2.default)(function (rule) {
    return rule.test(data);
  }, parsedRules);
};

var applySchemaRules = function applySchemaRules(obj) {
  var schemaProps = obj.schemaProps;
  var docProps = obj.docProps;


  var rule = matchRule(docProps);

  if (!schemaProps.length && rule) {
...
module.exports = applySchemaRules;