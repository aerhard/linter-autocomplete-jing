...
function runJing(textEditor, schema) {
  ...
  }).join(classPathDelimiter), 'com.thaiopensource.relaxng.util.Driver', '-S'].concat(schema.lang === 'xsd' && schema.path === '-' ? ['-x'] : [], schema.lang === 'dtd' ? ['-v'] : [], schema.lang === 'rnc' ? ['-c'] : [], [schema.path, xmlPath]);
