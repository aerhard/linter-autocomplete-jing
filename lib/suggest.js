...
var getSuggestions = function getSuggestions(sharedConfig, suggestionOptions) {
  ...
  return serverProcessInstance.sendRequest(headers, body).then((0, _fp.flow)(JSON.parse, function (data) {
...
var suggest = function suggest(options, _ref15) {
  ...
  return function (_ref16) {
    var _ref16$ = _ref16[1];
    var schemaProps = _ref16$.schemaProps;
    var xmlCatalog = _ref16$.xmlCatalog;
